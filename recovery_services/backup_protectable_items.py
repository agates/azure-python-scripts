...
def get_protectable_items(subscription_id,
                          resource_group_name,
                          vault_name,
                          request_session):
...
def get_protectable_items_in_resource_group(subscription_id,
                                            resource_group_name,
                                            vault_name,
                                            request_session):
    protectable_items = get_protectable_items(subscription_id, resource_group_name, vault_name, request_session)
    ...
    return (
        ...
        if resource_group_name in protectable_item['name'].lower()
    )
